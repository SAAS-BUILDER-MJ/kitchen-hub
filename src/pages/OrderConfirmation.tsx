...
import { fetchOrder, DbOrder } from '@/lib/supabase-api';
...
const OrderConfirmation = () => {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center p-4"><p>Loading...</p></div>;
  }

  if (!order) {
    return <div className="min-h-screen flex items-center justify-center p-4"><p>Order not found</p></div>;
  }
